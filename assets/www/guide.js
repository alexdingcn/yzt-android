        ...
        success:function(data){
            ...
            if (ads) {
                for(var i=0;i<ads.length;i++){
                    var url = ads[i].url;
                    adContent += '<div class="adite2m" data-url="'+ ads[i].url + '">'
            ...
            if (promotions) {
                ...
                for (var i=0; i<promotions.list.length; i++) {
                    ...
                    if (promotions.list[i].url) {
                        $("#promotion" + i + " .product_image").click(function(event){
                              window.location.href = promotions.list[i].url;
                        });
                    }
                }
            }
            ...
            if (promotions) {
                ...
                for (var i=0; i<promotions.list.length; i++) {
                    ...
                    if (promotions.list[i].url) {
                        $("#prom" + i + " .product_image").click(function(event){
                              window.location.href = promotions.list[i].url;
                        });
                    }
                }
